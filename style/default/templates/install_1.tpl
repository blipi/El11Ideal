		...
		<div id="page-bg">
		  <div id="sidebar1" class="sidebar">
				...
				<ul>
					<li>
						...
						<ul>
						  <li>
							...
							RECUERDAME
							<input type="checkbox" name="recuerda" value="ON" />
                            <br><br/>
					...
					<li>
						...
						<ul>
                        	<li>CREA TU EQUIPO:
                            <br><br/>
							<CENTER><input type="submit" value="REGISTRARSE" a href="#" /></CENTER>
                            <br/>
			...
			<div id="content">
				...
				<div class="post">
				  <h1 class="title"><CENTER>Instalación de la Base de Datos<br>
                  </CENTER></h1>
                  <table width="539" height="232" border="1">
                      <tr>
                        <td height="226">		
						Por favor, introduzca los siguientes datos sobre la base de datos:<br>
						<form method='post' action='{ACTION}?i=1'>
						<table width='300' align='center' style='border: 1px solid #000000;'>
							<tr><td width='40%'>Host </td><td><input type='text' name='host'></td></tr>
							<tr><td width='40%'>Username </td><td><input type='text' name='user'></td></tr>
							<tr><td width='40%'>Password </td><td><input type='password' name='pass'></td></tr>
							<tr><td width='40%'>Nombre db </td><td><input type='text' name='name'></td></tr>
							<tr><td width='40%'>Prefijo </td><td><input type='text' name='pref' value='el11_'></td></tr>
							<tr><td colspan='2' align='center'><input type='submit' value='Enviar'></td></tr>
						</table>
						</form><br>
						<form method='post' action='{ACTION}?i=2'>
						<table width='300' align='center' style='border: 1px solid #000000;'>
							<tr><td width='40%'>Prefijo </td><td><input type='text' name='pref' value='el11_'></td></tr>
							<tr><td colspan='2' align='center'><input type='submit' value='Saltar este paso'></td></tr>
						</table>
						</form><br>
						<form method='post' action='{ACTION}?i=3'>
						<table width='300' align='center' style='border: 1px solid #000000;'>
							<tr><td width='40%'>Prefijo </td><td><input type='text' name='pref' value='el11_'></td></tr>
							<tr><td colspan='2' align='center'><input type='submit' value='Actualizar DB'></td></tr>
						</table>
						</form><br>
                        </p></td>
                      </tr>
